...
class HomeFatigueController {
  static List<HomeFatigueScoreModel> fatigueScoreList = [
  ...
  static final homeFatigueScoreProvider = StateNotifierProvider<HomeFatigueScore, double>((ref) => HomeFatigueScore());
}